...
export function Hero() {
  return (
    <Container className="pb-16 pt-28 text-center">
      <h1 className="mx-auto max-w-4xl font-lora text-5xl font-light tracking-tight sm:text-[5.3rem] italic animate-fade-up delay-300">
        <span className="font-architype text-primary text-8xl tracking-wide not-italic ">
